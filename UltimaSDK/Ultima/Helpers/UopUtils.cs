    ...
    static public class UopUtils
    {
        ...
        public static (bool success, byte[] data) Decompress(byte[] compressedData)
        {
            ...
            try
            {
                ...
                using (var zlibStream = new ZLibNative.ZLIBStream(compressedStream, CompressionMode.Decompress, false))
        ...
        public static (bool success, byte[] compressedData) Compress(byte[] rawData)
        {
            ...
            try
            {
                ...
                using (var resultStream = new MemoryStream())
                using (var zlibStream = new ZLibNative.ZLIBStream(resultStream, CompressionLevel.Optimal))
                {
