...
namespace RazorEnhanced.Reflection.Objects
{
    public class GameScene : ReflectionObject
    {
        ...
        {
            dynamic game = Helpers.Reflection.GetTypePropertyValue<dynamic>( "ClassicUO.Client", "Game", null );
            ...
            Type gameSceneType = ClassicUOClient.CUOAssembly.GetType( "ClassicUO.Game.Scenes.GameScene" );
