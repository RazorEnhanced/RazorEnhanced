...
namespace Assistant
{
	internal class AVIRec
	{
		[System.Runtime.InteropServices.DllImport("Gdi32.dll")]
		private static extern IntPtr DeleteObject(IntPtr hGdiObj);

		internal static bool Recording { get { return m_RecTimer != null && m_RecTimer.Running; } }
		...
		internal static void UpdateFlip()
		{
		...
		internal static bool Record(int fps, double sizeFactor)
		{
	...
	internal class AVIFile
	{
		...
		internal bool Open(string fileName, int frameRate, int width, int height)
		{
		...
		internal bool AddFrame(Bitmap bmp)
		{
