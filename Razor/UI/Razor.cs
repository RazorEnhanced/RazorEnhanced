...
namespace Assistant
{
    ...
    "ith us! You are welcome!";
			...
			this.buttonScriptRefresh.Location = new System.Drawing.Point(72, 97);
			this.buttonScriptRefresh.Name = "buttonScriptRefresh";
			this.buttonScriptRefresh.Size = new System.Drawing.Size(30, 27);
			...
			// buttonAddScript
			// 
			this.buttonAddScript.ColorTable = office2010BlueTheme;
			...
			// buttonRemoveScript
			// 
			this.buttonRemoveScript.ColorTable = office2010BlueTheme;
			...
			// buttonScriptDown
			// 
			this.buttonScriptDown.ColorTable = office2010BlueTheme;
			...
			// buttonScriptUp
			// 
			this.buttonScriptUp.ColorTable = office2010BlueTheme;
			...
			// buttonScriptEditor
			// 
			this.buttonScriptEditor.ColorTable = office2010BlueTheme;
			...
			// 
			this.FriendGuildAddButton.ColorTable = office2010BlueTheme;
			...
			this.FriendGuildAddButton.Theme = RazorEnhanced.UI.Theme.MSOffice2010_BLUE;
			this.FriendGuildAddButton.Click += new System.EventHandler(this.FriendGuildAddButton_Click);
			// 
			// FriendGuildRemoveButton
			// 
			this.FriendGuildRemoveButton.ColorTable = office2010BlueTheme;
			...
			this.FriendGuildRemoveButton.Theme = RazorEnhanced.UI.Theme.MSOffice2010_BLUE;
