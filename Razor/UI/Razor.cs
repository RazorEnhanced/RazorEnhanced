...
namespace Assistant
{
    ...
    "ith us! You are welcome!";
			...
			this.blockchivalryhealCheckBox.Text = "Bock ChivaHeal if no need";
			...
			this.blockbighealCheckBox.Text = "Bock BigHeal if no need";
			...
			this.blockminihealCheckBox.Text = "Bock MiniHeal if no need";
