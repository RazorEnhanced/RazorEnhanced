...
namespace Assistant
{
	...
	public class MacroInsertWait : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.radioPause = new XRadioButton();
			this.pause = new XTextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.radioGump = new XRadioButton();
			this.radioTarg = new XRadioButton();
			this.radioStat = new XRadioButton();
			this.statAmount = new XTextBox();
			this.statList = new XComboBox();
			this.cancel = new XButton();
			this.statOpList = new XComboBox();
			this.radioMenu = new XRadioButton();
			this.SuspendLayout();
			// 
			// insert
			// 
