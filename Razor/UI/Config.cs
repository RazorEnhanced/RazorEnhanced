...
namespace Assistant
{
	internal class Profile
	{
		...
		internal void AddProperty(string name, object val)
		{
	...
	internal class Config
	{
		...
		internal static Profile CurrentProfile
		{
			get
			{
				if (m_Current == null)
		...
		internal static bool LoadProfile(string name)
		{
		...
		internal static void NewProfile(string name)
		{
			if (m_Current != null)
				m_Current.Unload();
		...
		internal static void SaveCharList()
		{
			if (m_Chars == null)
				m_Chars = new Hashtable();
		...
		internal static bool LoadLastProfile()
		{
		...
		internal static void SetupProfilesList(ComboBox list, string selectName)
		{
		...
		internal static string GetRegString(Microsoft.Win32.RegistryKey hkey, string vname)
		{
			try
			{
		...
		internal static void SetProperty(string name, object val)
		{
			CurrentProfile.SetProperty(name, val);
		}

		internal static void AddProperty(string name, object val)
		{
		...
		internal static bool SetRegString(RegistryKey hkey, string vname, string value)
		{
		...
		internal static void DeleteRegValue(Microsoft.Win32.RegistryKey hkey, string vname)
		{
		...
		internal static void RecursiveCopy(string oldDir, string newDir)
		{
		...
		internal static void CopyUserFiles(string appDir, string name)
		{
			RecursiveCopy(Path.Combine(GetInstallDirectory(), name), Path.Combine(appDir, name));
		}

		internal static string GetUserDirectory(string name)
		{
		...
		internal static string GetInstallDirectory(string name)
		{
		...
		internal static string LastProfileName
		{
			get
			{
