...
namespace RazorEnhanced
{
    ...
    public static class SeasonManager
    {
        ...
        private static readonly string _seasonsFile = Path.Combine(Assistant.Engine.RootPath, "Config", "seasons.txt");
        ...
        public static void LoadSeasonFile()
        {
            ...
            using StreamReader reader = new(_seasonsFile);
        ...
        private static void CreateDefaultSeasonsFile()
        {
            ...
            using StreamWriter writer = new(_seasonsFile);
