...
namespace Assistant
{
    ...
    internal class SpecialMoves
    {
        ...
        private static readonly AbilityInfo[] m_Primary = new AbilityInfo[]
        {
            ...
            new AbilityInfo( AOSAbility.InfectiousStrike, ButcherKnifeID, GargishButcherKnifeID, AssassinSpikeID ),
            ...
            new AbilityInfo( AOSAbility.ShadowStrike, SkinningKnifeID, DaggerID, ClubID, ShortSpearID, GargishDaggerID ),
        ...
        private static readonly AbilityInfo[] m_Secondary = new AbilityInfo[]
        {
            ...
            new AbilityInfo( AOSAbility.InfectiousStrike, CleaverID, PikeID, KryssID, DaggerID, DoubleBladedStaffID, DualShortAxesID, GargishCleaverID, GargishDaggerID, GargishKryssID, GargishPikeID ),
            ...
            new AbilityInfo( AOSAbility.ShadowStrike, TwoHandedAxeID, CutlassID, SmithsHammerID, SledgeHammerID, AssassinSpikeID ),
