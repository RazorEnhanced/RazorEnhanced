    ...
    internal static class AgentStatusGump
    {
        ...
        private static bool GetAgentEnabled(int index)
        {
            ...
            switch (index)
            {
                ...
                case 2: return BuyAgent.Status();
                case 3: return SellAgent.Status();
                case 4: return BandageHeal.AutoMode;
        ...
        private static void ToggleAgent(int index)
        {
            ...
            var main = Assistant.Engine.MainWindow;
            if (main == null)
                return;
            ...
            main.SafeAction(s =>
            {
                ...
                {
                    case 0:
                        s.AutolootCheckBox.Checked = !s.AutolootCheckBox.Checked;
                        break;
                    case 1:
                        s.ScavengerCheckBox.Checked = !s.ScavengerCheckBox.Checked;
                        break;
                    case 2:
                        s.BuyCheckBox.Checked = !s.BuyCheckBox.Checked;
                        break;
                    case 3:
                        s.SellCheckBox.Checked = !s.SellCheckBox.Checked;
                        break;
                    case 4:
                        s.BandageHealenableCheckBox.Checked = !s.BandageHealenableCheckBox.Checked;
                        break;
                }
            });
        }
