...
namespace RazorEnhanced.UI
{
	public partial class EnhancedScavengerEditItem : Form
	{
		...
		public EnhancedScavengerEditItem(string list, int index, Scavenger.ScavengerItem item)
		{
			InitializeComponent();
			MaximizeBox = false;
		...
		private void bAddItem_Click(object sender, EventArgs e)
		{
			...
			if (!fail)
			{
				RazorEnhanced.Scavenger.ModifyItemInList(tName.Text, graphics, color, m_Item.Selected, m_Item, m_Index);
