...
namespace RazorEnhanced
{
	public class Spells
	{
		...
		internal static void CastNecroHotKey(string SpellName)
		{
			if (World.Player == null)
				return;
		...
		internal static void CastChivalryHotKey(string SpellName)
		{
			if (World.Player == null)
				return;
		...
		internal static void CastBushidoHotKey(string SpellName)
		{
			if (World.Player == null)
				return;
		...
		internal static void CastNinjitsuHotKey(string SpellName)
		{
			if (World.Player == null)
				return;
		...
		internal static void CastSpellweavingHotKey(string SpellName)
		{
			if (World.Player == null)
				return;
		...
		internal static void CastMysticismHotKey(string SpellName)
		{
			if (World.Player == null)
				return;
