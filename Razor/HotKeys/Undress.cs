...
namespace Assistant.HotKeys
{
	internal class UndressHotKeys
	{
		...
		internal static void ToggleRight()
		{
		...
		internal static void ToggleLeft()
		{
		...
		internal static bool Unequip(Layer layer)
		{
		...
		internal static void OnUndressAll()
		{
		...
		internal static void OnUnequipJewelry()
		{
		...
		internal static void OnUnequipHat()
		{
			Unequip(Layer.Head);
		}

		internal static void OnUnequipBothHands()
		{
			Unequip(Layer.RightHand);
			Unequip(Layer.LeftHand);
		}

		internal static void OnUnequipRight()
		{
			Unequip(Layer.RightHand);
		}

		internal static void OnUnequipLeft()
		{
			Unequip(Layer.LeftHand);
		}
	}
