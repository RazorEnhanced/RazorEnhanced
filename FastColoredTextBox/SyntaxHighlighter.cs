...
";
		...
		protected void InitPythonRegex()
		{
			...
			string SpellsFunctions = "CastMagery|CastNecro|CastChivalry|CastBushido|CastNinjitsu|CastSpellweaving|CastMysticism|CastCleric|CastDruid|CastMastery|Interrupt|CastLastSpell";
